...
<div class="header-container">
    ...
    <div class="header-info">
        ...
        <div class="search-by-name">
            ...
            ?>
            <input type="text" id="search-university" value="<?= $search_value ?>" placeholder="<?php echo esc_attr__('Search by name...', 'sit-connect'); ?>" />
        ...
        <div class="filter-sidebar-content">
            ...
            <div class="filter-section">
                ...
                <div class="price-range-inputs">
                    ...
                    ?>
                    <input type="number" class="price-input" placeholder="<?php echo esc_attr__('Min', 'sit-connect'); ?>" id="minPrice" value="<?= $min_fee ?>">
                    <span class="price-separator">-</span>
                    <input type="number" class="price-input" placeholder="<?php echo esc_attr__('Max', 'sit-connect'); ?>" id="maxPrice" value="<?= $max_fee ?>">
                </div>
            </div>
